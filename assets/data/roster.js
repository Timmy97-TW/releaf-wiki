...
/* ---------- Sections, in display order ----------------------------------
   Two sections only: every student in one alphabetical list, then the
   instructors. The old split into project leads, student leaders, student
   members, student advisors and a support team is in the git history if it
   is ever wanted back; it was flattened so the page reads as one team.
   ------------------------------------------------------------------------ */
const SECTIONS = [
  {
    id: "student-members",
